        ...
        <form action="methods/pushObzor.php" method="POST" class="section-poster__form" enctype="multipart/form-data">
            ...
            <div class="poster-instruments">
                ...
                <div class="poster-editing">
                    <div class="poster-editing__name">
                        <input class="poster-editing__title" type="text" name="nameFilm" id="nameFilm"
                        placeholder="+название" value="<?= $_SESSION['test_obzor']->nameFilm ?>" required />
                    </div>
                    <div class="poster-editing__body">
                        <p class="poster-editing__obzor">Обзор:</p>
                        <div class="poster-editing__textarea">
                            <textarea name="textObzor" maxlength=5000 rows="26" id="textObzor"
                            class="poster-editing__textarea-redacted"
                            placeholder="Напишите ваш обзор"><?= $_SESSION['test_obzor']->textObzor ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="poster-trailer">
                ...
                <div class="poster-trailer__youtubeLink">
                    ...
                    <input class="poster-trailer__link" type="text" name="linkTrailer" id="link__trailer"
                    value="<?= $_SESSION['test_obzor']->linkTrailer ?>" required />
                </div>
