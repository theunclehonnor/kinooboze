		...
		<div class="section-poster__form">
				...
				<div class="poster-editing">
					...
					<div class="poster-editing__body">
						...
						<div class="poster-editing__textarea">
							<textarea name="textobzora" maxlength=5000 rows="20" id="textobzora" class="poster-editing__textarea-redacted" readonly><?= $_SESSION['obzor']->textObzor ?></textarea>
						</div>
					</div>
				</div>
			</div>
			<div class="poster-trailer">
				...
				<div class="poster-trailer__youtubeLink">
					<iframe class="poster-trailer__iframe" src=<?= $_SESSION['obzor']->linkTrailer ?> frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
			<div class="poster-comment">
				...
				<!-- Возможно тут нужна только форма, а внешнюю закрыть -->
				<form action="methods/addComment.php" method="post" class="comment-add
					...
					<div class="comment-add__textarea">
						<textarea name="textAddComment" maxlength=350 rows="7" id="textAddComment" class="comment-add__textarea-redacted" placeholder="Оставьте свой комментарий"></textarea>
					</div>
