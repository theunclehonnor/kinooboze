		...
		<div class="registration">
			...
			<form action="methods/signin.php" method="post" class="registration__form">
				...
				<div class="form-group form-group__resize">
					...
					<input class="form__input form__input_resize" type="email" name="email" id="email" placeholder="Email address" value="<?= $_SESSION['email'] ?>" required />
				</div>
				<div class="form-group form-group__resize">
					<label class="form__label form__label_resize" for="password">Пароль:</label>
					<input class="form__input form__input_resize" type="password" name="password" id="password" placeholder="Password" required />
				</div>
